...
function MonDb(options){
    ...
    options.servers.forEach(function(server) {
        ...
        _objServer = {host:_tempArr[0],port:_tempArr[1]};
...
MonDb.prototype.getDb =function(dbName){
     var _this = this;
   if(this._otherDB.indexOf(dbName)>-1){
...
MonDb.prototype.getObjectID = function(){
     //return  new ObjectID().toHexString();
     return new ObjectID();
}
MonDb.prototype.toObjectID = function(fileId){
